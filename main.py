...
def getParams() -> None:
    ...
    while True:
        ...
        centeredPrint(screen, font, "Parameters", (250, 20))
        centeredPrint(screen, tinyfont, "Default Settings are automatically provided!", (250, 40))
...
def drawCurve() -> List[Tuple[int, int]]:
    ...
    while True:
        ...
        centeredPrint(screen, font, "Draw a Continuous Curve!", (250, 20))
...
def preview(eq: str, r: List[Tuple[float, float]]) -> None:
    ...
    while True:
        ...
        centeredPrint(screen, font, "Equation Generated!", (250, 20))
