...
class ButtonStyle:
    def __init__(self, *, fillColor: Tuple[int, int, int] = None,
                 hoverFillColor: Tuple[int, int, int] = None, hoverBorderColor: Tuple[int, int, int] = None,
                 borderColor: Tuple[int, int, int] = None, borderThickness: int = None, texture: pygame.SurfaceType = None,
                 collisionTexture: pygame.SurfaceType = None, 
...
class Button:
    ...
    def draw(self, mousePos: Tuple[int, int]) -> None:
        ...
        if collision(mousePos, self.rect):
            ...
            centeredPrint(ButtonManager.screen, self.font, self.text, self.centre, self.fontColor)
